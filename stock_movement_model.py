...
from sqlalchemy import DateTime, Enum as SQLEnum, ForeignKey, Index, String, Integer, Numeric
...
class StockMovement(Base):
    ...
    canonical_id: Mapped[UUID | None] = mapped_column(PGUUID(as_uuid=True), nullable=True, index=True)
    ...
    source: Mapped[str] = mapped_column(String(20), nullable=False)  # "hourly" | "daily"
    ...
    __table_args__ = (
        Index("ix_stock_movements_provider_city_time", "provider_name", "city", "snapshot_at"),
